                ...
                <ul class="nav metismenu" id="side-menu">
                    <li class="nav-header">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
															<span class="clear"> 
																<span class="block m-t-xs">
																	<strong class="font-bold">{{session('session_login')['username']}}</strong>
																</span> 
																<span class="text-muted text-xs block">{{session('session_login')['occupation']}}<b class="caret"></b></span> 
															 </span> 
														</a>
                        ...
                        <ul class="nav nav-second-level collapse" style="height: 0px;">
                            <li><a href="{{url('')}}">Purchse</a></li>
                            <li><a href="{{url('')}}">Sales</a></li>
														<li><a href="{{url('')}}">Return Purchase</a></li>
														<li><a href="{{url('')}}">Return Purchase</a></li>
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level collapse">
                            ...
                            <li>
                                <a href="{{url('')}}">Stock</a></li>
                            <li>
                                <a href="{{url('')}}">Second Level Item</a>
														</li>
                        </ul>
                    </li>
                    <li>
        ...
        <div class="navbar-header">
            ...
            <form role="search" class="navbar-form-custom" action="search_results.html">
                <div class="form-group">
                    <input type="text" name="global_search" placeholder="Search for something..." class="form-control" name="top-search" id="top-search"/>
        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="footer">
                    ...
                    <div>
                        <strong>Copyright</strong>&nbsp;Patran Tech&copy;2017
                    </div>
                </div>
            </div>
        </div>
